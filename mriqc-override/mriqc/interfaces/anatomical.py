...
class StructuralQC(SimpleInterface):
    ...
    def _run_interface(self, runtime):  # pylint: disable=R0914,E1101
        orgnii = nb.load(self.inputs.in_file)
        orgdata = np.nan_to_num(orgnii.get_fdata())
        ...
        # FBER
        self._results['fber'] = fber(orgdata, headdata, rotdata) #inudata
