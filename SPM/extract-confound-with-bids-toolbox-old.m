datadir = fullfile(pwd, 'project/derivatives'); % fmriprep dataset location
resdir = fullfile(pwd, 'project/results'); % output location

extract_confounds(datadir, resdir, 'stories')

function extract_confounds(ipath, opath, task)
